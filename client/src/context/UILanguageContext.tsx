...
export const translations = {
  en: {
    ...
    imageUrl: 'Image URL',
    avatarSeedLabel: 'Avatar seed (any text)',
    avatarSeedPlaceholder: 'e.g. your name or anything...',
  ...
  he: {
    ...
    avatarSeedLabel: 'זרע אווטאר (כל טקסט)',
    avatarSeedPlaceholder: 'לדוגמה: שמך...',
    imageUrlPlaceholder: 'https://example.com/photo.jpg',
    ...
    toastPasswordMinLength: 'הסיסמה חייבת להכיל לפחות 6 תווים',
    // Auth pages
